...
dictionary_search <- 
  function() {
    data_frame(column = c("search_criteria", "city", "county", "discovery_mode", "state", 
                        "postal", "sort", "position", "facets", "search_controller", 
                        "neighborhood", "street", "searchType", "school", "types", "searchFacetsToDTM", 
                        "searchFeaturesToDTM", "pos", "page_size", "viewport_height", 
                        "pin_height", "page",
                        "beds_min", "beds_max", "baths_min", "baths_max", "price_min", 
                        "price_max", "prop_type", "sqft_min", "sqft_max", "acre_min", 
                        "acre_max", "lot_unit", "age_max", "age_min", "radius", "pets", 
                        "days_on_market", "open_house", "show_listings", "pending", "foreclosure", 
                        "new_construction", "multi_search", "include_pending_contingency", 
                        "features_hash"),
               nameActual = c("locationSearch", "citySearch", "countySearch", "isDiscoveryMode", "stateSearch", 
                              "zipcodeSearch", "remove_sort", "remove_position", "listFacets", "remove_search_controller", 
                              "neighborhoodSearch", "streetSearch", "typeSearch", "schoolSearch", "typeProperty", "remove_searchFacetsToDTM", 
                              "remove_searchFeaturesToDTM", "remove_pos", "remove_zie_page", "remove_viewport_height", 
                              "remove_pin_height", "numberPage",
                              "countBedsMin", "countBedsMax", "countBathsMin", "countBathsMax", "priceMin", 
                              "priceMax", "typeProperty", "areaSFMin", "areaSFMax", "areaLandAcreMin", 
                              "areaLandAcreMax", "lotUnit", "ageMax", "ageMin", "radiusMiles", "hasPets", 
                              "countDaysOnMarket", "hasOpenHouse", "isShowListing", "isPending", "isForeclosure", 
                              "isNewConstruction", "isMultiSearch", "hasPendings", 
                              "listFeatures")
...
.headers_base <- 
  function() {
    structure(list(cookie = "threshold_value=56; automation=false; clstr=v; clstr_tcv=14; __vst=06687a89-26aa-424d-8d01-4b45dba07097; __ssn=358102aa-3f72-4ee6-855c-b5fcc80b4a25; __ssnstarttime=1520516724; basecamp=false; ajs_user_id=null; ajs_group_id=null; ajs_anonymous_id=%22f6e9aa90-48d4-4348-8ab9-c0bfa18c7593%22; AMCVS_8853394255142B6A0A4C98A4%40AdobeOrg=1; far_geo=%7B%22CityState%22%3A%7B%22City%22%3A%22Marietta%22%2C%22SearchAreaID%22%3A114%2C%22StateID%22%3A%22GA%22%7D%2C%22CityStateSearch%22%3Afalse%2C%22ConfidenceLevel%22%3A0%2C%22Country%22%3A%22USA%22%2C%22Intersection%22%3A%22%22%2C%22Latitude%22%3A33.927089%2C%22Longitude%22%3A-84.541084%2C%22MatchedMethod%22%3A3%2C%22PostalCode%22%3A%2230060%22%2C%22PostalCodeSearch%22%3Atrue%2C%22Street%22%3A%22%22%7D; _agent-profile_session=SGRBeHNiQ0gvWGx6b0F6VVdCSlF3aVFac0M4WkZiTlBHT3ZwQ0ptUXN4YktiS1BsL2NPckt6MVVZWU93YXBzZ1NHSGxyZFVqek5PU3JKbG1aeS9Vd2IrVlg0NEFVeGpUVTJPK0xPN1htWWk0Ylo2b2p0OTM2TURaci9pcko2dDM2MnBESVpOZjF2VHN1OGg3aU9ST2d3PT0tLWFMaFlGdndMR25JVWt4allBQjF5b3c9PQ%3D%3D--f9e08c793eeb963927612fce658aff9db51418fe; search_params=%7B%22geo_slug%22%3A%2230060%22%2C%22_pjax%22%3A%22%23pjax-container%22%2C%22agent_rating_min%22%3A%225%22%2C%22has_photo%22%3A%221%22%2C%22price_range%22%3A%22500000_7000000%22%7D; srp.viewType=map; criteria=loc%3DMarietta%2C+GA%26locSlug%3DMarietta_GA%26lat%3D33.967466%26long%3D-84.521937%26status%3D1%26pos%3D33.632572%2C-85.211782%2C34.246659%2C-84.071951%2C10%26pg%3D1%26pgsz%3D15%26sprefix%3D%2Frealestateandhomes-search%26city%3DMarietta%26state_id%3DGA%26county_fips%3D13067%26county_fips_multi%3D13067-13057-13121; srchID=b2e1aea3f17045a8afa891a6476b9d24; AMCV_8853394255142B6A0A4C98A4%40AdobeOrg=-179204249%7CMCIDTS%7C17599%7CMCMID%7C44784613493650775057191498471160544248%7CMCAID%7CNONE%7CMCOPTOUT-1520546418s%7CNONE; header_slugs=gs%3DMarietta_GA%26lo%3DMarietta%26st%3Dcity%2Cgs%3DCobb-County_GA%26lo%3DCobb%26st%3Dcity; _rdc-next_session=SlJZdWxsdHhJdkY0WmVMVTF4SjBHVklJLzdQNTJyNjJ0dlNWK1J6TGo2ck1GVDNnNGRWbitrelZuQ010MDFXUk43WjkzTFhuMEVENkRvYWhwYW9zTnp2ZTF4a0pLbDdlTTFBSWpPOXJDRmh3ZmVGM0lVWFRDRmQ3K0VzdUFiV2hpMm81Vlo1TUhsUy9LdFJHd3RpUXZnPT0tLU9ZbW9xLy9LalB5UU5La0VpZDZFdGc9PQ%3D%3D--5e31ae7054e456e659789555eebafab0925c5602", 
                   ...
                   `x-newrelic-id` = "VwEPVF5XGwYEV1JaDwAD", `user-agent` = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.124 Safari/537.36", 
                   `content-type` = "application/json", accept = "application/json, text/javascript, */*; q=0.01", 
                   referer = "https://www.compass.com/", authority = "www.realtor.com", 
                   dnt = "0"), .Names = c("cookie", "origin", "accept-encoding", 
                                          "x-csrf-token", "accept-language", "x-requested-with", "x-newrelic-id", 
                                          "user-agent", "content-type", "accept", "referer", "authority", 
                                          "dnt"), row.names = c(NA, -1L), class = c("tbl_df", "tbl", "data.frame"
                                          ))
...
.data_base <- 
  function() {
    structure(list(search_criteria = "location_slug", city = "", 
                   county = "", discovery_mode = TRUE, state = "", postal = NULL, 
                   sort = NULL, position = NULL, facets = structure(list(beds_min = NULL, 
                                                                         beds_max = NULL, baths_min = NULL, baths_max = NULL, 
                                                                         price_min = NULL, price_max = NULL, prop_type = "", sqft_min = NULL, 
                                                                         sqft_max = NULL, acre_min = NULL, acre_max = NULL, lot_unit = NULL, 
                                                                         age_max = NULL, age_min = NULL, radius = NULL, pets = NULL, 
                                                                         days_on_market = NULL, open_house = NULL, show_listings = NULL, 
                                                                         pending = NULL, foreclosure = NULL, new_construction = NULL, 
                                                                         multi_search = structure(list(), .Names = character(0)), 
                                                                         include_pending_contingency = TRUE, features_hash = list()), .Names = c("beds_min", 
                                                                                                                                                 "beds_max", "baths_min", "baths_max", "price_min", "price_max", 
                                                                                                                                                 "prop_type", "sqft_min", "sqft_max", "acre_min", "acre_max", 
                                                                                                                                                 "lot_unit", "age_max", "age_min", "radius", "pets", "days_on_market", 
                                                                                                                                                 "open_house", "show_listings", "pending", "foreclosure", 
                                                                                                                                                 "new_construction", "multi_search", "include_pending_contingency", 
                                                                                                                                                 "features_hash")), search_controller = "Search::PropertiesController", 
                   neighborhood = NULL, street = NULL, searchType = "city", 
                   school = NULL, types = "property", searchFacetsToDTM = "pf_not_visible", 
                   searchFeaturesToDTM = list(), pos = "", page_size = 2500L, 
                   viewport_height = 1000L, pin_height = 240L, page = 1L), .Names = c("search_criteria", 
                                                                                      "city", "county", "discovery_mode", "state", "postal", "sort", 
                                                                                      "position", "facets", "search_controller", "neighborhood", "street", 
                                                                                      "searchType", "school", "types", "searchFacetsToDTM", "searchFeaturesToDTM", 
                                                                                      "pos", "page_size", "viewport_height", "pin_height", 'page'))
...
.generate_data <- 
  function(location_name,
    ...
    if (!include_pending_contingency %>% purrr::is_null()) {
      data$facets$include_pending_contingency <- include_pending_contingency
    }
    data$page <- page
...
.get_location_counts <- 
  function(location_name = 10016,
    ...
    df_loc_val <- 
      ...
      mutate(id = 1) %>% 
      left_join(
        df_params %>% mutate(id = 1) %>% select(-locationSearch)
      ) %>% 
  ...
  function(locations ,
    ...
    locations %>% 
      map_df(function(location){
        .get_location_counts_safe(location_name = location,
                             search_type = search_type,
                             city_isolated = city_isolated,
                             county_isolated = county_isolated,
                             zipcode_isolated = zipcode_isolated,
...
.get_location_listings_json <- 
  function(location_name = 10016,
           ...
           include_pending_contingency = TRUE) {
    df_count <- 
      .get_location_counts( location_name = location_name,
                            search_type = search_type,
                            city_isolated = city_isolated,
                            county_isolated = county_isolated,
                            zipcode_isolated = zipcode_isolated,
...
listings <- 
  function(locations = NULL,
    ...
    all_data <- 
      locations %>% 
      map_df(function(location){
        .get_location_listings(location_name = location,
                                search_type = search_type,
                                city_isolated = city_isolated,
                                county_isolated = county_isolated,
                                zipcode_isolated = zipcode_isolated,
